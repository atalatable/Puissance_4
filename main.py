    ...
    while choice != 3:
        ...
        if choice == 1: local(grid)
            ...
            while multichoice != 3:
                ...
                if multichoice == 1: host(wrapper(multiplayer_address_menu, 0, "127.0.0.1", "4444"), grid)
                if multichoice == 2: join(wrapper(multiplayer_address_menu, 1, "88.160.115.96", "25565"))
